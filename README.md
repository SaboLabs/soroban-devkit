...
# 9. (Optional) Build and sign the envelope without submitting it, for review
#    or air-gapped signing. Prints the base64 envelope + computed fee + sequence.
sdkt invoke <CONTRACT_ID> increment --args u32:1 --identity my-deployer --network-profile testnet --build-only
```
