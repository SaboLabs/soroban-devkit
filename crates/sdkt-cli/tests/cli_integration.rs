...
// ---------------------------------------------------------------------------
// 4.1 — `sdkt.lock` generation / inspection (offline, hermetic).
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// 4.2 — invalid project dependency graphs (offline, hermetic).
...
// ---------------------------------------------------------------------------
// — Git dependency sources: validation + fetch (offline, local git).
...
// ---------------------------------------------------------------------------
// — Package update & synchronization (offline, local git remotes).
...
// --- packaging / publishing CLI integration tests --------------------
